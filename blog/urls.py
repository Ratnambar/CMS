...
from blog.views import indexPage,PostListView,PostFormView,search_code,view_by_cat_button,BtnBlogDetails, contact, post_edit_form_view,post_details_view,like_post,PostFormUpdateView,PostFormDeleteView
